...
import { KTIcon } from '../../../../_molekul/helpers'
import { getCSSVariableValue } from '../../../../_molekul/assets/ts/_utils'
import { Dropdown1 } from '../../../../_molekul/partials/content/dropdown/Dropdown1'
import { useThemeMode } from '../../../../_molekul/partials/layout/theme-mode/ThemeModeProvider'
...
const MixedWidget2: React.FC<Props> = ({ className, chartColor, chartHeight, strokeColor }) => {
  ...
  return (
    <div className={`card ${className}`}>
      {/* begin::Header */}
      <div className={`card-body border-0 rounded py-5 h-250px bg-${chartColor}`}>
        <div>
          <h1 className="text-white fw-bolder pt-5" style={{ fontSize: '20px' }}>Halo M. Dzikri Alfarisyi</h1>
          <h1 className="text-white fw-bolder pe-10" style={{ fontSize: '20px' }}>Selamat Datang di Ajar Koding!</h1>
          <p className="text-white" style={{ fontSize: "16px" }}>
            Disini kamu akan mengenal konsep algoritma dan<br /> pemrograman dengan menggunakan model <br />pembelajaran Reciprocal Teaching
          </p>
        </div>
      </div>
      <div className='card-body p-0'>
        ...
        <div className='card-p mt-n20 position-relative'>
          ...
          <div className='row g-0'>
            {/* begin::Col */}
            <div className='col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7 h-200px'>
